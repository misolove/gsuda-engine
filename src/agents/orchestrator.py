...
def emit_recommendation() -> TradeRecommendation:
    ...
    return TradeRecommendation(
        ...
        features={
            ...
            "d2": "Tiger",
            "signal": "Buy",
            "year_pillar": "FireHorse",
            "month_pillar": "MetalGoat",
            "day_pillar": "MetalTiger",
            "year_pillar_hanja": "丙午",
            "month_pillar_hanja": "辛未",
            "day_pillar_hanja": "庚寅",
            "year_pillar_english": "Fire Horse",
            "month_pillar_english": "Metal Goat",
            "day_pillar_english": "Metal Tiger",
            "jieqi_zone": "middle",
            "month_progress": 0.52,
